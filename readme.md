...
| 设置 | 侧边栏标题栏 **齿轮图标**，打开设置页（左侧分类、右侧内容；当前含「快捷键」） |
...
侧边栏标题栏点击 **齿轮图标** 可打开「Tab Groups 设置」页面，在左侧选择 **快捷键**，点击快捷键框后按下组合键录入，保存后写入 `.vscode/settings.json` 并同步到本机 keybindings，使快捷键立即生效。
