...
| 操作 | 说明 |
|------|------|
| 打开文件 | 单击文件名；有游标时跳到第一个游标位置 |
| 从分组中移除 | 右键文件 → **从分组中移除** |
| 添加游标 | 右键文件 → **添加游标**（可添加多个）；文件下可展开查看游标列表 |
| 删除 / 重命名游标 | 展开文件后右键游标节点 |
| 复制路径 | 右键文件 → **复制路径** |
...
| 添加游标 | `Ctrl+Shift+L` | 编辑器内；追加到当前文件游标列表 |
| 上一游标 | `Ctrl+Shift+[` | 在当前文件已保存游标间循环 |
| 下一游标 | `Ctrl+Shift+]` | 在当前文件已保存游标间循环 |
